...
**Source:** [Flickr 8k Dataset](https://www.kaggle.com/datasets/adityajn105/flickr8k)
...
Model(
  ...
  (fusion): Sequential(
    (0): Linear(in_features=1536, out_features=30524, bias=True)
    (1): ReLU()
...
```sh
git clone https://github.com/aakash-dec7/ImageToCaption.git
cd ImageToCaption
```
